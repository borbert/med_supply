 ...
 * 
 * Maps product categories to their corresponding image categories
 * for consistent image display across the application.
 * 
...
/**
 * Returns a random image for a given category
 * 
 * @param {string} category - The product category
 * @returns {string|undefined} A random image URL or undefined if no images are found
 */
